...
const waBase = "https://wa.me/919142713879?text="

const waGaming = waBase + encodeURIComponent(
`Hello! I want to book a gaming slot 🎮
...
const waPrint = waBase + encodeURIComponent(
`Hello! I want to order a 3D print 🖨️

Details:
- Name:
- Material (PLA/TPU/Wood/Glow):
- STL file (Yes/No):
- Quantity:
- Delivery or Pickup:
`
...
const waWorkshop = waBase + encodeURIComponent(
`Hello! I want to register for a workshop 🎓
...
const contactInfo = [
  ...
  },
  {
    ...
    title: "WhatsApp",
    value: "Chat with us",
    href: waBase + encodeURIComponent("Hello! I want to know more."),
  },
  {
    icon: Mail,
    title: "Email",
    value: "keshavkumar81027@gmail.com",
    href: "mailto:keshavkumar81027@gmail.com",
  },
  {
    icon: MapPin,
    title: "Address",
    value: "Lakhisrai(Bihar), India",
    href: "#map",
  },
]
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                <Button variant="outline" className="neon-border flex-1 bg-transparent" asChild>
                  <a href="https://www.instagram.com/honeybyte_/" target="_blank" rel="noopener noreferrer">
                    <Instagram className="mr-2 h-5 w-5" />
                    Instagram
                  </a>
                </Button>
                <Button variant="outline" className="neon-border flex-1 bg-transparent" asChild>
                  <a href="https://discord.gg/kcVrh4rm" target="_blank" rel="noopener noreferrer">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Button className="neon-glow-purple" asChild>
              <a href={waGaming} target="_blank" rel="noopener noreferrer">
                Book Gaming Slot (WhatsApp)
              </a>
            </Button>
            <Button className="neon-glow-blue bg-accent text-accent-foreground hover:bg-accent/90" asChild>
              <a href={waPrint} target="_blank" rel="noopener noreferrer">
                Order 3D Print (WhatsApp)
              </a>
            </Button>
            <Button variant="outline" className="neon-border bg-transparent" asChild>
              <a href={waWorkshop} target="_blank" rel="noopener noreferrer">
                Register Workshop (WhatsApp)
              </a>
            </Button>
          </div>
        </div>
